...
NDiplomacy = {
	...
	TENSION_STATE_VALUE = 1,						-- Tension value gained by annexing one state
	...
	TENSION_ANNEX_NO_CLAIM = 1,						-- Amount of tension generated by annexing a state you don't have claims on
	...
	TENSION_DECAY = 0.2,							-- Each months tension decays this much
	TENSION_SIZE_FACTOR = 1,						-- All action tension values are multiplied by this value
	...
	TENSION_GUARANTEE = -6,
	TENSION_FACTION_JOIN = 3,
	TENSION_JOIN_ATTACKER = 2,						-- scale of the amount of tension added when country joins attacker side
	TENSION_PEACE_FACTOR = 0.75,					-- scale of the amount of tension (from war declaration) reduced when peace is completed.
	TENSION_LIBERATE = -2,							-- Amount of tension generated by liberating a country.
